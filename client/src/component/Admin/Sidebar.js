...
const Sidebar = () => {
  ...
  <div className="p-4">
    <ul className="list-unstyled">
      <li><a  onClick={()=>nav("/")} className="d-block py-2 px-4 text-dark text-decoration-none hover-bg-gray-200 rounded sidebar-style">Dashboard</a></li>
      ...
      <li><a  onClick={()=>nav("/adminProjectsTask")} className="d-block py-2 px-4 text-dark text-decoration-none text-gray-700 hover-bg-gray-200 rounded sidebar-style">Employee Project Task</a></li>
    </ul>
  </div>
</aside>
